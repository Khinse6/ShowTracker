...
public class ShowStoreContext : IdentityDbContext<User>
{
    ...
    public DbSet<RefreshToken> RefreshTokens => Set<RefreshToken>(); // <--- Add this
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // ----------------------------
        // Seed Shows, Seasons, Episodes, Genres, ShowGenres
        // (your existing seeding code)
        // ----------------------------
        modelBuilder.Entity<Show>().HasData(
            new Show { Id = 1, Title = "Stranger Things", Description = "A group of kids uncover supernatural mysteries in their small town.", ReleaseDate = new DateOnly(2016, 7, 15) },
            new Show { Id = 2, Title = "The Crown", Description = "Chronicles the life of Queen Elizabeth II from the 1940s onward.", ReleaseDate = new DateOnly(2016, 11, 4) },
            new Show { Id = 3, Title = "Bridgerton", Description = "Wealthy families navigate romance and scandal in Regency-era London.", ReleaseDate = new DateOnly(2020, 12, 25) }
        );
